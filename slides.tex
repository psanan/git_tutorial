...
\item 
  Beware \href{https://www.stackoverflow.com}{StackOverflow}: do not panic and start pasting mysterious commands (understand things in terms of the DAG first), and note that a lot of the advice is specific to old versions of git.
